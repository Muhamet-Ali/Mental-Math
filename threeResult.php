...
$resultLevel = $connection->query("SELECT * FROM level WHERE id=3");///////
    ...
    <div class="container">
        ...
        <div class="result">
            ...
            <div class="buttons">
                ...
                <?php if ($showBtn): ?>
                    <form action="levelFore.php" method="POST"><!--/////////// -->
                        <button type="submit" class="btn btn-danger">انتقل للمستوى الرابع</button>
                    </form>
                <?php endif; ?>
            </div>
        </div>
